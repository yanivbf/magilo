...
export interface ApiDaySettingDaySetting extends Struct.CollectionTypeSchema {
  collectionName: 'day_settings';
  info: {
    description: 'Working hours, breaks, and closed days for service providers';
    displayName: 'Day Setting';
    pluralName: 'day-settings';
    singularName: 'day-setting';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    breaks: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    closedDates: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Required;
    isWorkingDay: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::day-setting.day-setting'
    > &
      Schema.Attribute.Private;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Form submissions and appointment bookings';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-generated landing pages';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer purchases from store/course/restaurant pages';
  ...
  attributes: {
    ...
    pickedAt: Schema.Attribute.DateTime;
    products: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    shipping: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    status: Schema.Attribute.Enumeration<
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Platform user who can create and manage pages';
    displayName: 'User';
    pluralName: 'users';
    singularName: 'user';
  };
